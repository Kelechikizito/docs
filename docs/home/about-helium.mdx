...
**IOT Token:** A token specific to the **Long Range Wide Area Network (LoRaWAN)** network, enabling low-power, wide-area network connectivity for Internet of Things (IoT) devices. PoC is employed for the LoRaWAN subnetwork.
